...
<div class="page-container">
	<div class="text-c"> 日期范围：
        ...
        <input runat="server" id="txtTime" type="text" class="input-text Wdate" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" style="width:120px;" />
		-
		<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax" class="input-text Wdate" style="width:120px;">
		<input type="text" class="input-text" style="width:250px" placeholder="输入会员名称、电话、邮箱" id="" name="">
         <asp:Button ID="btnTime" runat="server" CssClass="btn btn-success radius" Text="查询" OnClick="btnTime_Click" /><i class="Hui-iconfont">&#xe665;</i>
	</div>
     

	<div class="cl pd-5 bg-1 bk-gray mt-20">
         <span class="l">  <asp:Button CssClass="btn btn-danger radius" runat="server" ID="Button1" Text="批量删除" OnClick="btnDelete_Click" />
        <i class="Hui-iconfont">&#xe6e2;</i></span> <span class="r"> 报名总数量:<strong> <asp:Label ID="lbcount" runat="server" ></asp:Label></strong> 人</span> </div>
          部门：
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <ItemTemplate>
          	<tr class="text-c">
               ...
               <td><%# Eval("Time") %></td>
               <td><asp:LinkButton ID="delete" Text="删除" runat="server" CommandName="delete" CssClass="ml-5" CommandArgument='<%# Eval("ApplicationId") %>'><i class="Hui-iconfont">&#xe6e2;</i></asp:LinkButton></td>
           </tr>
