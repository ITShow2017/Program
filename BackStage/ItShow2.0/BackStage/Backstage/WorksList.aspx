...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加作品','WorksAdd.aspx','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加作品</a></span> <span class="r">共有作品：<strong> <asp:Label ID="lbcount" runat="server" ></asp:Label></strong> 件</span> </div>
	<div class="mt-20">
...
<tr class="text-c">
               ...
               <td><asp:LinkButton ID="editor" CssClass="ml-5" runat="server" Text="编辑" PostBackUrl='<%# "Worksditor.aspx?id="+ Eval("WorksId") %>'><i class="Hui-iconfont">&#xe6df;</i></asp:LinkButton></td>
               <td><asp:LinkButton ID="delete" CssClass="ml-5" Text="删除" runat="server" CommandName="delete" CommandArgument='<%# Eval("WorksId") %>'><i class="Hui-iconfont">&#xe6e2;</i></asp:LinkButton></td>
           </tr>
