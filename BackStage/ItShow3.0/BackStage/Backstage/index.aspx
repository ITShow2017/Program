		...
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">爱特工作室</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li id="Hui-msg"> 
                       <a href="Comment-list.aspx" title="消息"><asp:Label ID="lbMessage" runat="server" CssClass="badge badge-danger"></asp:Label><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
