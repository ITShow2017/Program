...
<body>
    ...
    <div>
     编辑成员
        ...
        星座:
         <asp:DropDownList ID="Constellation" runat="server" >
            <asp:ListItem Selected="True">白羊座</asp:ListItem>
            <asp:ListItem>金牛座</asp:ListItem>
            <asp:ListItem>双子座</asp:ListItem>
            <asp:ListItem>巨蟹座</asp:ListItem>
            <asp:ListItem>狮子座</asp:ListItem>
            <asp:ListItem>处女座</asp:ListItem>
            <asp:ListItem>天秤座</asp:ListItem>
            <asp:ListItem>天蝎座</asp:ListItem>
            <asp:ListItem>射手座</asp:ListItem>
            <asp:ListItem>摩羯座</asp:ListItem>
            <asp:ListItem>水瓶座</asp:ListItem>
            <asp:ListItem>双鱼座</asp:ListItem>
        </asp:DropDownList><br />
        爱好：<br />
