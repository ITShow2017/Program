...
$(function(){
	...
	/*$(".closepop").css({
		...
		"right":($(".pop-member").width()-$(".pop-member-in").width())/2
	});*/
	//弹窗的位置
	$(".container").css({
			"height":$(window).height(),
	...
	$(".member-contain").delegate(".every-member-in","click",function(){
	    //var j=$(this).parents(".member-entrance").find(".member-contain").index($(this).parents(".member-contain"));
	    //var i =$(this).parents(".member-contain").find(".every-member-in").index(this)+j*8;
