...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="member_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加成员','MemberAdd.aspx','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加成员</a></span> <span class="r">共有成员：<strong>   <asp:Label runat="server" ID="lbcount" ></asp:Label></strong> 人</span> </div>
	<div class="mt-20">
             年级：
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="r">本届成员：<strong>   <asp:Label runat="server" ID="lbcount1" ></asp:Label></strong> 人</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <ItemTemplate>
         <tr class="text-c">
               ...
               <td><asp:LinkButton ID="editor" CssClass="ml-5" runat="server" Text="编辑" PostBackUrl='<%# "MemberEditor.aspx?id="+ Eval("MemberId") %>'><i class="Hui-iconfont">&#xe6df;</i></asp:LinkButton></td>
               <td><asp:LinkButton ID="delete" CssClass="ml-5" Text="删除" runat="server" CommandName="delete" CommandArgument='<%# Eval("MemberId") %>'><i class="Hui-iconfont">&#xe6e2;</i></asp:LinkButton></td>
           </tr>
